...
class ClienteServiceTest {
    ...
    void deveConverterDeDtoParaEntidade() {
        ...
        // Assert
        assertAll("Conversão de DTO para Entidade",
                () -> assertEquals("Carlos", convertido.getCliNome(), "Nome não convertido corretamente"),
                () -> assertEquals("12345678900", convertido.getCliCpf(), "CPF não convertido corretamente"),
                () -> assertFalse(convertido.getEnderecos().isEmpty(), "Lista de endereços vazia"),
                () -> assertEquals("Rua B", convertido.getEnderecos().get(0).getEndRua(), "Rua não convertida"),
                () -> assertFalse(convertido.getContatos().isEmpty(), "Lista de contatos vazia"),
                () -> assertEquals("98888-0000", convertido.getContatos().get(0).getConCelular(), "Celular não convertido")
        );
    }
